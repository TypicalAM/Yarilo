...
class ListMenu:
    def __init__(self, display):
        ...
        self.items = ["Get sniffer list", "Get access point list", "Focus/Ignore network", "Active focus", "Create recording", "Restart"]
...
class ButtonHandler:
    ...
    def handle_accept_action(self, selected):
        ...
        elif selected == "Active focus":
            self.display.show_message(client.get_active_focus())
